"""Setup for libraryproblem XBlock."""
...
setup(
    ...
    entry_points={
        'xblock.v1': [
            'library-problem = libraryproblem:GoogleDocumentBlock',
        ]
    },
    package_data=package_data("libraryproblem", ["static", "templates", "public"]),
)
